    ...
    <div className="container">
      ...
      <div className="card-grid">
        ...
        {metrics.abandonment_rate > 20 && (
          <div className="card high">
            ...
            <p>High abandonment detected. Reduce billing wait time.</p>
          </div>
        )}
        ...
        {heatmap.high_attention_zone && (
          <div className="card low">
            ...
            <p>{heatmap.high_attention_zone}</p>
      ...
      <div className="card-grid">
        <div className="card insight-card">
          ...
          <p><strong>Dataset Used:</strong> entry_1.mp4, entry_2.mp4</p>
          <p><strong>Visitors Detected:</strong> {liveTracking.visitors}</p>
          <p><strong>Insight:</strong> Customer footfall tracked.</p>
        </div>

        <div className="card insight-card">
          <h3>🛒 Billing Queue Monitoring</h3>
          <p><strong>Dataset Used:</strong> billing_area.mp4</p>
          <p><strong>Queue Depth:</strong> {liveTracking.queue_depth}</p>
          <p>
            <strong>Risk:</strong>{" "}
        ...
        <div className="card insight-card">
          ...
          <p><strong>Dataset Used:</strong> zone.mp4 + store-layout.png</p>
          <p>
            <strong>High Attention Zone:</strong>{" "}
            {liveTracking.high_attention_zone}
          </p>
          <p>
            <strong>Dwell Time:</strong> {liveTracking.dwell_time}s
          </p>
        </div>
      </div>

      <h2>Live CCTV Events</h2>
      ...
      >
        ...
        <p>
          Detects queue spikes, improves conversion visibility, tracks customer
          movement, identifies high attention zones, and provides real-time
          operational intelligence for stores.
        </p>

        <p>
          Tech Stack: FastAPI + React + Event Analytics + Funnel Intelligence +
          Heatmap Analysis + Anomaly Detection + Dataset-Based CCTV Intelligence
        </p>
      </footer>
    </div>
  );
